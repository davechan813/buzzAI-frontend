        ...
        <div className="container">
          <div className="hero-inner">
            <div className="hero-copy">
              <h1 className="hero-title mt-0">vuSearch</h1>
          ...
          <div className="features-inner section-inner">
            <div className="features-header text-center">
              <div className="container-sm">
                <h2 className="section-title mt-0">vuSearch</h2>
                <p className="section-paragraph">
                  vuSearch provides AI analytics solutions for offline
                  retail industry. Our technology achieves automated
                  analytics of images, natural languages, and other
                  meta data of any data source, which enables us to
                  analyze big data without having human involved. We
                  provide an actionable analytic results which helps
                  marketers to think important business strategies.
                </p>
              </div>
            </div>
              ...
              <div className="feature text-center is-revealing">
                <div className="feature-inner">
                  ...
                  <p className="text-sm">
                    ...
                    and printing in place of English to emphasise
                    design elements.
                  </p>
                </div>
              </div>
      ...
      <div className="container">
        <div className="site-footer-inner has-top-divider">
          ...
          <div className="footer-copyright">
            © 2018 vuSearch, all rights reserved
          </div>
        </div>
      </div>
    </footer>
